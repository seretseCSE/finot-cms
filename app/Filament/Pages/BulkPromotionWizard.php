...
class BulkPromotionWizard extends Page implements HasTable
{
    ...
    public static function canAccess(): bool
    {
        ...
        // Remove access for finance_head - only allow education management roles
        return $user?->hasRole(['superadmin', 'admin', 'education_head', 'teacher', 'registrar']);
    }
