...
class ManageCustomOptions extends Page implements HasTable
{
    ...
    protected function mergeOptionValueIntoTarget(string $fieldName, string $fromValue, string $toValue): void
    {
        $map = [
            ...
            'inventory_category' => ['table' => 'inventory_items', 'column' => 'category'],
            'inventory_unit' => ['table' => 'inventory_items', 'column' => 'unit'],
            'title' => ['table' => 'members', 'column' => 'title'],
            'member_type' => ['table' => 'members', 'column' => 'member_type'],
            'member_status' => ['table' => 'members', 'column' => 'status'],
            'occupation_status' => ['table' => 'members', 'column' => 'occupation_status'],
            'marital_status' => ['table' => 'members', 'column' => 'marital_status'],
            'aid_type' => ['table' => 'aid_distributions', 'column' => 'aid_type'],
            'loss_type' => ['table' => 'loss_records', 'column' => 'loss_type'],
            'withdrawal_reason' => ['table' => 'student_enrollments', 'column' => 'withdrawal_reason'],
        ];
