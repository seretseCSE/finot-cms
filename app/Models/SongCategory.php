...
class SongCategory extends BaseModel
{
    ...
    protected static function boot(): void
    {
        ...
        static::creating(function (SongCategory $category) {
    ...
    {
        return $this->hasMany(SongSubcategory::class, 'category_id')->orderBy('display_order');
    }

    public function activeSubcategories(): HasMany
    {
        return $this->hasMany(SongSubcategory::class, 'category_id')->where('status', 'Active')->orderBy('display_order');
    }
    ...
    {
        return $this->hasMany(Song::class, 'category_id')->where('is_active', true);
    }
