...
class MemberGroup extends BaseModel
{
    ...
    protected static function boot(): void
    {
        ...
        static::creating(function ($group) {
            // Automatically set created_by to current logged-in user
            $user = auth()->user();
            if ($user) {
    ...
    /**
     * Get contribution amounts for this group
     */
    public function contributionAmounts()
    {
        return $this->hasMany(ContributionAmount::class, 'group_id');
    }
