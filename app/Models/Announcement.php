...
class Announcement extends BaseModel
{
    ...
    {
        return url('/placeholder/announcement.png');
    }
    ...
    /**
     * Check if announcement should be published (for scheduled announcements)
     */
    ...
    public function publish(): void
    {
        ...
        Log::channel('audit')->info('Tier 1 Audit Log', [
            ...
            'new_value' => json_encode(['status' => 'Active', 'published_at' => now()]),
            'user_id' => 'system',
