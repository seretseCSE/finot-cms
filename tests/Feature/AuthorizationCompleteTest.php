...
class AuthorizationCompleteTest extends TestCase
{
    ...
    {
        $role = Role::create(['name' => 'test_role', 'label' => 'Test role', 'guard_name' => 'web']);
    ...
    public function test_multiple_roles_cumulative(): void
    {
        ...
        $role1 = Role::create(['name' => 'role1', 'label' => 'Role1', 'guard_name' => 'web']);
        $role2 = Role::create(['name' => 'role2', 'label' => 'Role2', 'guard_name' => 'web']);
