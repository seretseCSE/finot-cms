...
abstract class TestCase extends BaseTestCase
{
    ...
    /**
     * Track which test classes have already seeded shared data.
     *
     * @var list<class-string>
     */
    protected static array $seededClasses = [];
    ...
    protected function setUp(): void
    {
        ...
        if (! in_array(static::class, self::$seededClasses)) {
            ...
            // RefreshDatabase wraps each test in a transaction; commit it
            // so seeded data persists across tests in this class.
            ...
            self::$seededClasses[] = static::class;
        }

        // Clear session state to prevent session token collisions across tests
