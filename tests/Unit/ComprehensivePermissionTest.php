...
class ComprehensivePermissionTest extends TestCase
{
    ...
    protected function seedAllPermissions(): void
    {
        ...
        // Clear permission cache so Spatie picks up the newly created permissions
    ...
    protected function getAllUserstoryPermissions(): array
    {
        return [
            ...
            // === ARCHIVES & DOCUMENTS ===
            'documents.upload', 'documents.update', 'documents.delete', 'documents.view',
    ...
    public function test_role_permission_counts(): void
    {
        ...
        $staffCount = $staff->getAllPermissions()->pluck('name')->count();
