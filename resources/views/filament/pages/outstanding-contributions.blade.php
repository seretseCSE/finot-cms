        ...
        @else
            ...
            <div class="bg-white rounded-lg shadow p-6 border border-gray-200 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Member Group</label>
                        <select wire:model.live="group_id" class="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Ethiopian Month (1-13)</label>
                        <select wire:model.live="month" class="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-800 dark:text-white">
