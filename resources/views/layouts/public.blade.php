...
<head>
    ...
    <!-- Fonts: Inter + Playfair Display + Noto Sans/Sans Ethiopic + DM Sans -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,900;1,400;1,600;1,700&family=Noto+Sans+Ethiopic:wght@400;500;600;700&family=Noto+Serif+Ethiopic:wght@400;600;700;900&family=DM+Sans:wght@300;400;500;600&display=swap" rel="stylesheet">
    <style>
        @font-face {
            font-family: 'Nyala';
            src: local('Nyala'), local('Nyala-Regular');
            font-display: swap;
        }
        .font-nyala { font-family: 'Nyala', 'Noto Sans Ethiopic', serif; }
    </style>
