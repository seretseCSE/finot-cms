...
/**
 * The profile-rail avatar with an in-place photo uploader: tap the camera
 * badge, pick an image, done — no digging through the documents tab. Gated
 * by the caller's custody-aware canUpdate; read-only views render the plain
 * avatar.
 */
  ...
  return (
    <div {...dropProps} className={cn("relative rounded-3xl", dragOver && DROP_ACTIVE)}>
      ...
      <Button
        ...
        title={photoUrl ? t("photo.change") : t("photo.add")}
        disabled={busy}
