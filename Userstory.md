 ...
 *Actors: Admin, Superadmin, Finance Head, Nibret ena Hisab Department Head*
...
* ✅ **Admin manually updates "Total Raised":**  
  * Admin, Superadmin, Finance Head, or Nibret ena Hisab Department Head enters amount received offline (cash, bank transfers, etc.)  
...
* ✅ **Notification record fields:**  
  ...
  * User ID (recipient)  
  * Notification Type (tour_registration, attendance_lock_reminder, etc.)  
